...
def build_signals(kline_df: pd.DataFrame, sentiment_scores: pd.Series | None = None) -> pd.DataFrame:
    """为单只股票构建完整信号表
    ...
    Returns:
        包含 technical_signal, sentiment_signal, combined_signal 列的 DataFrame
    """
